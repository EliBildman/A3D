                ...
                if (
                    ...
                    if (newInfo[hoverTop].type === ENTITY_TYPES.ACTION) {
                        ...
                        Object.values(newInfo)
                            .filter(
                                (entity) => entity.type === ENTITY_TYPES.ACTION
                            )
                            .forEach((action) => {
                                for (const arrow of Object.values(
                                    action.arrows
                                ))
                                    if (arrow.to === top) {
                                        if (
                                            getTop(arrow.from, newInfo) !==
                                            hoverTop
                                        ) {
                                            arrow.to = hoverTop;
                                        } else {
    ...
    const pickUp = (id) => {
        ...
        while (blockId != null) {
            ...
            if (depth > MAX_FARGMENT_LENGTH) {
                console.error(
                    'Max fragment length reached, something went wrong'
                );
                setHeld([]);
                break;
            }
